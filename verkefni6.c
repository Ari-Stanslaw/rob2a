...
void forward()
{
	while(abs(SensorValue[leftEncoder]) < 1128) // While the right encoder is less than distance:
	{
		motor[rightMotor] = 80;		  // Motor on port2 is run at full (60) power reverse
		motor[leftMotor]  = 80;		  // Motor on port3 is run at full (60) power
	}
}
void left(int deg)
{
